 ...
 */
sampleCollection = new Backbone.Collection([
    { name: 'user 1', email: 'user1@email.com' },
    { name: 'user 2', email: 'user2@email.com' },
    { name: 'user 3', email: 'user3@email.com' },
    { name: 'user 4', email: 'user4@email.com' },
    { name: 'user 5', email: 'user5@email.com' },
    { name: 'user 6', email: 'user6@email.com' },
    { name: 'user 7', email: 'user7@email.com' },
    { name: 'user 8', email: 'user8@email.com' },
    { name: 'user 9', email: 'user9@email.com' },
    { name: 'user 10', email: 'user10@email.com' },
]);
...
countries = new Backbone.Collection([
    ...
    { abbreviation: "BQ", name: "British Antarctic Territory" },
    ...
    { abbreviation: "CT", name: "Canton and Enderbury Islands" },
    ...
    { abbreviation: "CD", name: "Congo - Kinshasa" },
    ...
    { abbreviation: "NQ", name: "Dronning Maud Land" },
    { abbreviation: "DD", name: "East Germany" },
    ...
    { abbreviation: "FQ", name: "French Southern and Antarctic Territories" },
    ...
    { abbreviation: "HK", name: "Hong Kong SAR China" },
    ...
    { abbreviation: "JT", name: "Johnston Island" },
    ...
    { abbreviation: "MO", name: "Macau SAR China" },
    ...
    { abbreviation: "FX", name: "Metropolitan France" },
    { abbreviation: "MX", name: "Mexico" },
    { abbreviation: "FM", name: "Micronesia" },
    { abbreviation: "MI", name: "Midway Islands" },
    ...
    { abbreviation: "NT", name: "Neutral Zone" },
    ...
    { abbreviation: "SR", name: "Suriabbreviation" },
    ...
    { abbreviation: "WK", name: "Wake Island" },
